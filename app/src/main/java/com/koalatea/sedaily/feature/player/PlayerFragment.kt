...
//                val activity = this@PlayerFragment.activity
...
//                ?: return
//        playerViewModel?.playPause(controller)
//    }
//
//    /* Playback events */
...
//
//        // @TODO: Make reactive
//        val currentPosition: Long? = playerViewModel?.setListenedProgress(mLastPlaybackState!!) // @TODO: Null check
...
//        // @TODO: Make reactive
//        playerViewModel?.sendSpeedChangeIntent(currentSpeed, this.activity as Activity)
//    }
//
...
//
//    fun back15() {
//        playerViewModel?.back15(this.activity as Activity)
//    }
//
//    fun skip15() {
//        playerViewModel?.skip15(this.activity as Activity)
//    }
}